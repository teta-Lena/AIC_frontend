      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          ...
          <p className="text-xl mt-20">
            Hello there! 👋 Let me tell you my story, a passionate software
            developer with three years of hands-on experience in crafting
            innovative and efficient solutions. My journey in the world of
            coding has led me to excel in a diverse range of technologies, with
            a particular focus on Vue, Angular, Node.js, React, and React
            Native.
          </p>
        </div>
