...
const Pictures = () => {
  ...
  const imageStyle = "w-100 h-100 border-2 border-black-330"; // Apply the same style to all images

  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black to-[#390101]/80  w-full text-white md:h-screen"
    >
